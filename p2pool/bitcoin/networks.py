...
#unsigned char pchMessageStart[4] = { 0xfe, 0xa5, 0x03, 0xdd };
        ...
        P2P_PREFIX='aebfc0d1'.decode('hex'),
        P2P_PORT=22871,
        ADDRESS_VERSION=30,
        RPC_PORT=22872,
        RPC_CHECK=defer.inlineCallbacks(lambda bitcoind: defer.returnValue(
            'deepcoinaddress' in (yield bitcoind.rpc_help()) and
            not (yield bitcoind.rpc_getinfo())['testnet']
        )),
        SUBSIDY_FUNC=lambda height: 512*100000000 >> (height + 1)//43200,
#        SUBSIDY_FUNC=lambda height: 750*100000000 >> (height + 1)//21600,
#        SUBSIDY_FUNC=lambda height: 60*100000000, >> (height + 1)//48840,
